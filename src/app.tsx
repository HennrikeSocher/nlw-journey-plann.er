    ...
    <div className="h-screen flex items-center justify-center bg-pattern bg-no-repeat bg-center">
      <div className="max-w-3xl w-full px-6 text-center space-y-10">
        ...
        <p className="text-sm text-zinc-500">
          ...
          <br /> com nossos{" "}
          <a className="text-zinc-50 underline" href="#">
            {" "}
            termos de uso{" "}
          </a>{" "}
          e{" "}
          ...
          <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
            ...
            <div className="flex flex-wrap gap-2">
              <div className="py-1.5 px-2.5 rounded-md bg-zinc-800 flex items-center gap-2">
                <span className="text-zinc-300">hennrikesocher@gmail.com</span>
                <button type="button">
            ...
            <form
              action=""
              className="py-2.5 bg-zinc-950 border-l-zinc-800 rounded-lg flex items-center gap-2"
            >
              <div className="px-2 flex items-center flex-1">
                <AtSign className="size-5 text-zinc-400" />
                <input
                  type="text"
                  placeholder="Digite o email do convidado"
                  className="bg-transparent text-lg placeholder:bg-zinc-400 outline-none flex-1"
                />
              </div>
              <button className="bg-lime-300 text-lime-950 px-5 py-2 rounded-lg font-medium flex items-center gap-2 hover:bg-lime-400">
                Confirmar
